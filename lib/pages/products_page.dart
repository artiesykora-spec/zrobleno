                    ...
                    (product) => Dismissible(
                      ...
                      child: Card(
                        child: ListTile(
                          ...
                          onTap: () =>
                              editProduct(context, widget.store, product),
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: _MacroField(controller: protein, label: 'Білки')),
                  const SizedBox(width: 7),
                  Expanded(child: _MacroField(controller: fat, label: 'Жири')),
                  const SizedBox(width: 7),
                  Expanded(child: _MacroField(controller: carbs, label: 'Вугл.')),
                ],
              ),
              const SizedBox(height: 10),
